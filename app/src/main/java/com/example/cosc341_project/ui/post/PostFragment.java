...
public class PostFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        button1.setOnClickListener(view -> {//Create creatingSightingPost post
            creatingSightingPost = true;
            Intent intent = new Intent(requireContext(), createPost.class);
            intent.putExtra("creatingSightingPost", creatingSightingPost);
            startActivity(intent);
        });

        button2.setOnClickListener(view -> {//Create discussion post
            creatingSightingPost = false;
            Intent intent = new Intent(requireContext(), createPost.class);
            intent.putExtra("creatingSightingPost", creatingSightingPost);
            startActivity(intent);
